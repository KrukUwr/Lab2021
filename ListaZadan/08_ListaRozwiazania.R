...
library(MASS)
example <- mvrnorm(n = 1000, mu = c(0,0), Sigma = matrix(c(1,0.6,0.6,1),2,2), empirical = FALSE)
...
qplot(PC1,PC2,data=CasesPCA, colour = Client, label=Client, xlab = "PC1", ylab = "PC2",size=I(1))
